#
# Created by System Generator     Thu Feb  8 10:38:37 2018
#
...
namespace eval ::xilinx::dsptool::iseproject::param {
    ...
    set ProjectFiles {
        {{darkquad29_cw.vhd} -view All}
        {{darkquad29.vhd} -view All}
        {{darkquad29_cw.ucf}}
        {{darkquad29_cw.xdc}}
        ...
        {{/Scratch/firmware/chan1024/darkquad29.slx}}
    }
    set TopLevelModule {darkquad29_cw}
    set SynthesisConstraintsFile {darkquad29_cw.xcf}
