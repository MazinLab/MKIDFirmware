...
%12 bit data pairs on bus0, [data0_2, data0_3, ...data0_13], [lsb ... msb]
ext_ports.data0_p         = {12 'in' ['adc_data0_p'] ['{',adcport1,'_p{[11 31 2 22 12 32 3 23 13 33 4 24],:}}'] 'vector=true' struct() ucf_constraints_term};
ext_ports.data0_n         = {12 'in' ['adc_data0_n'] ['{',adcport1,'_n{[11 31 2 22 12 32 3 23 13 33 4 24],:}}'] 'vector=true' struct() ucf_constraints_term};
%2 bits for timestamp,overrange condition %data0_0,data0_1
ext_ports.info0_p         = {2 'in' ['adc_info0_p'] ['{',adcport1,'_p{[1 21],:}}'] 'vector=true' struct() ucf_constraints_term};
ext_ports.info0_n         = {2 'in' ['adc_info0_n'] ['{',adcport1,'_n{[1 21],:}}'] 'vector=true' struct() ucf_constraints_term};

ext_ports.data1_p         = {12 'in' ['adc_data1_p'] ['{',adcport1,'_p{[16 36 7 27 17 37 8 28 18 38 9 29],:}}'] 'vector=true' struct() ucf_constraints_term};
ext_ports.data1_n         = {12 'in' ['adc_data1_n'] ['{',adcport1,'_n{[16 36 7 27 17 37 8 28 18 38 9 29],:}}'] 'vector=true' struct() ucf_constraints_term};
ext_ports.info1_p         = {2 'in' ['adc_info1_p'] ['{',adcport1,'_p{[6 26],:}}'] 'vector=true' struct() ucf_constraints_term};
ext_ports.info1_n         = {2 'in' ['adc_info1_n'] ['{',adcport1,'_n{[6 26],:}}'] 'vector=true' struct() ucf_constraints_term};


ext_ports.data2_p         = {12 'in' ['adc_data2z0_p'] ['{',adcport0,'_p{[11 31 2 22 12 32 3 23 13 33 4 24],:}}'] 'vector=true' struct() ucf_constraints_term};
ext_ports.data2_n         = {12 'in' ['adc_data2z0_n'] ['{',adcport0,'_n{[11 31 2 22 12 32 3 23 13 33 4 24],:}}'] 'vector=true' struct() ucf_constraints_term};
ext_ports.info2_p         = {2 'in' ['adc_info2_p'] ['{',adcport0,'_p{[1 21],:}}'] 'vector=true' struct() ucf_constraints_term};
ext_ports.info2_n         = {2 'in' ['adc_info2_n'] ['{',adcport0,'_n{[1 21],:}}'] 'vector=true' struct() ucf_constraints_term};

ext_ports.data3_p         = {12 'in' ['adc_data3_p'] ['{',adcport0,'_p{[16 36 7 27 17 37 8 28 18 38 9 29],:}}'] 'vector=true' struct() ucf_constraints_term};
ext_ports.data3_n         = {12 'in' ['adc_data3_n'] ['{',adcport0,'_n{[16 36 7 27 17 37 8 28 18 38 9 29],:}}'] 'vector=true' struct() ucf_constraints_term};
ext_ports.info3_p         = {2 'in' ['adc_info3_p'] ['{',adcport0,'_p{[6 26],:}}'] 'vector=true' struct() ucf_constraints_term};
ext_ports.info3_n         = {2 'in' ['adc_info3_n'] ['{',adcport0,'_n{[6 26],:}}'] 'vector=true' struct() ucf_constraints_term};
...
ext_ports.sync_pps_p = {1  'in' ['adc_sync_pps_p'] ['{',adcport0,'_p{[30],:}}'] 'vector=false'  mhs_constraints ucf_constraints_clock};
ext_ports.sync_pps_n = {1  'in' ['adc_sync_pps_n'] ['{',adcport0,'_n{[30],:}}'] 'vector=false'  mhs_constraints ucf_constraints_clock};
